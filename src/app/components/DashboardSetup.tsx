                    ...
                    >
                      ...
                      <div className="flex-1">
                        <span className={`text-[15px] transition-colors duration-300 ${
                          isDone ? 'text-gray-400' : isActive ? 'text-gray-900 font-medium' : 'text-gray-300'
                        }`}>
                          {step.label}
                        </span>
                      </div>
            ...
            >
              ...
              <div className="w-full bg-[#0A0A0A] rounded-2xl p-1.5 pl-5 mb-10 flex items-center justify-between shadow-xl shadow-gray-200/50 border border-gray-800/60 transition-transform hover:scale-[1.01] duration-300">
                ...
                <button 
                  ...
                  className={`flex items-center gap-1.5 px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shrink-0 ml-4 shadow-sm cursor-pointer ${
                    copied
