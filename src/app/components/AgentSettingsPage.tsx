            ...
            {sections.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 md:w-full flex items-center justify-center md:justify-start gap-2 md:gap-3 px-4 py-3 text-sm font-medium transition-colors text-center md:text-left ${
