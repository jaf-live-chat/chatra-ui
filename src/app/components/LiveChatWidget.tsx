            ...
            <div className={`flex-1 overflow-y-auto ${dm.settingsBg}`} style={{ scrollbarWidth: "thin", scrollbarColor: "#d1d5db transparent" }}>
              ...
              <div className="px-5 pt-5 pb-4">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 mb-4 px-2 py-1 rounded-lg text-[13px] font-medium transition-colors cursor-pointer ${
                    darkMode
              ...
              <div className="px-5 py-4">
                ...
                <div className="flex items-center justify-between py-2.5">
                  ...
                  <button
                    ...
                    className={`relative w-10 h-[22px] rounded-full transition-colors duration-200 cursor-pointer ${
                      soundEnabled ? 'bg-cyan-600' : 'bg-gray-300'
                    }`}
                  >
                    <span className={`absolute top-[3px] left-[3px] w-4 h-4 bg-white rounded-full shadow-sm transition-transform duration-200 ${
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            ...
                            {msg.files && msg.files.filter(f => !f.type?.startsWith("image/") || !f.url).map((file, i) => (
                              <div key={`file-${i}`} className={`flex items-center gap-2 mb-1.5 p-2.5 rounded-2xl shadow-sm border ${
                            ...
                            {!fileOnly && (
                              <div
                                className={`px-3.5 py-2.5 rounded-2xl ${ts.message} ${ts.leading} shadow-sm ${
                                    msg.from === "user"
            ...
            <div className={`px-3 py-3 ${dm.inputWrapperBg} border-t flex flex-col gap-2`}>
              ...
              <div className={`rounded-xl transition-all duration-300 overflow-hidden ${
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium rounded-lg transition-colors cursor-pointer ${
                    showQuickMessages
                      ? `${theme.text}`
                      : dm.quickToggleBg
                  }`}
                ...
                <div className="flex flex-col items-center px-8 text-center">
                  ...
                  <div className="flex gap-2 w-full">
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-xl text-[13px] font-semibold transition-all cursor-pointer shrink-0 ${
                        darkMode
