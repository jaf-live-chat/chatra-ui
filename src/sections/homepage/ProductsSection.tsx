    ...
    <>
      <section id="products" className="py-24 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {/* Header */}
          <ScrollReveal preset="glide" duration={0.88} className="text-center max-w-2xl mx-auto mb-16">
            <span
          ...
          <div className="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/50 overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-16 flex flex-col justify-center">
                <ScrollReveal preset="swingLeft" duration={0.9} distance={26}>
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg"
                      style={{ backgroundColor: "#0891b2", boxShadow: "0 10px 15px -3px #0891b233" }}
                    >
                ...
                <ScrollReveal preset="glide" delay={0.05} duration={0.9}>
                  <p
                ...
                <ScrollReveal preset="pop" delay={0.1} duration={0.75}>
                    ...
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3">
                        <div
                          ...
                          style={{ backgroundColor: "#0891b214" }}
                        >
                ...
                <ScrollReveal preset="pop" delay={0.14} duration={0.7}>
                  <div className="flex flex-wrap gap-4 mt-auto">
                    <Link
                      ...
                      style={{
                        ...
                        boxShadow: "0 10px 15px -3px #0891b233",
                      }}
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: "#0891b233" }}
                ></div>
                <div
                  className="absolute bottom-0 left-0 w-64 h-64 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"
                  style={{ backgroundColor: "#22d3ee33" }}
                ></div>
                ...
                <div className="relative z-10 w-full max-w-md rounded-xl overflow-hidden border border-gray-800 shadow-2xl">
                  <div className="bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-gray-700">
                    ...
                    <div className="ml-4 text-xs text-gray-400 font-medium" style={{ fontFamily: "Inter, sans-serif" }}>
                      jaf-dashboard.app
                    </div>
                  </div>
                  <ImageWithFallback
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto overflow-hidden animate-fade-in-up">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
              <h3 className="text-xl font-bold text-slate-900" style={{ fontFamily: "Inter, sans-serif" }}>
