    ...
    <section className="bg-white py-12 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          {/* Left Content */}
          <div>
            <ScrollReveal preset="swingLeft" duration={0.9} distance={28}>
              <span
            ...
            <ScrollReveal preset="glide" delay={0.06} duration={0.88}>
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <span className="text-gray-600" style={{ fontFamily: "Inter, sans-serif", fontSize: "0.84rem" }}>
                      {item}
                    </span>
                  </li>
                ))}
            ...
            <ScrollReveal preset="pop" delay={0.1} duration={0.7}>
          ...
          {/* Right: Code Block */}
          <ScrollReveal preset="swingRight" delay={0.08} duration={0.95} distance={28} className="w-full">
            <div className="max-w-full overflow-hidden rounded-2xl border border-gray-800 shadow-2xl">
              ...
              <div className="flex items-center justify-between border-b border-gray-700 bg-gray-900 px-4 py-3 sm:px-5">
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className="max-w-[120px] truncate text-gray-400 sm:max-w-none"
                ...
                >
                  {lines.map((line, i) => (
                    <div key={i} className="flex items-start">
                      <span
                        className="mr-2 w-6 shrink-0 select-none text-right text-gray-600 sm:mr-4 sm:w-7"
