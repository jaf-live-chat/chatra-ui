  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center border-b-0">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 lg:gap-14 opacity-50">
          {/* Faked logos to match layout */}
          <div className="flex items-center gap-1.5 grayscale text-[#64748b] font-bold text-xl tracking-tight">
          ...
          <div className="flex items-center gap-1.5 grayscale text-[#64748b] font-bold text-xl tracking-tighter">
          ...
          <div className="flex items-center gap-1.5 grayscale text-[#64748b] font-bold text-2xl tracking-tighter uppercase relative top-[1px]">
            <span>NETFLIX</span>
          </div>
          <div className="flex items-center gap-1.5 grayscale text-[#64748b] font-semibold text-xl tracking-tighter lowercase">
          ...
          <div className="flex items-center grayscale text-[#64748b]">
